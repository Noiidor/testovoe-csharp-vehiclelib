...
Напишите SQL запрос в котором будет создание двух таблиц: Customers, Orders. Выведите имена всех покупателей не совершивших ни одной покупки.  
  
Первое задание находится в папке VehicleLib, а тесты к нему в VehicleLib.Tests  
Второе задание в файле Customers-Orders.sql